...
class ContactFormsControllerTest < ActionController::TestCase
  ...
  test "should create contact_form" do
    assert_difference('ContactForm.count') do
      post :create, contact_form: { email: @contact_form.email, firstName: @contact_form.firstName, lastName: @contact_form.lastName, message: @contact_form.message }
    end
  ...
  test "should update contact_form" do
    patch :update, id: @contact_form, contact_form: { email: @contact_form.email, firstName: @contact_form.firstName, lastName: @contact_form.lastName, message: @contact_form.message }
    assert_redirected_to contact_form_path(assigns(:contact_form))
  end
